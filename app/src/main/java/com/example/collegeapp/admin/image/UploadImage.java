...
import com.example.collegeapp.databinding.ActivityUploadImageBinding;
...
public class UploadImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Upload College Events");
        progressDialog=new ProgressDialog(this);
        reference= FirebaseDatabase.getInstance().getReference().child("gallery");
        storageReference= FirebaseStorage.getInstance().getReference().child("gallery");
        String[] items = new String[]{"Select Category","convocation","Independence Day","Others"};
        binding.imageCategory.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item,items));
    ...
    private void uploadData() {
        ...
        reference.child(uniquekey).setValue(downloadUrl).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                progressDialog.dismiss();
                binding.galleryImageView.setImageResource(0);
            }
